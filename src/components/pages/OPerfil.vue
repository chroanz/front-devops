<template>
    <div>
      ...
      <div class="bg-purple py-4 px-5 d-flex justify-content-between align-items-center">
      ...
      <div class="container my-4">
        ...
        <div class="row">
          <div v-for="(curso, index) in usuario.cursosEmAndamento" :key="'andamento-'+index" class="col-md-4 mb-4">
          ...
          <div v-if="usuario.cursosEmAndamento.length === 0" class="col-12 text-center py-4">
      ...
      <div class="container my-4">
        <h3 class="mb-4 text-black">Últimos cursos concluídos</h3>
        
        <div class="row">
          <div v-for="(curso, index) in usuario.cursosConcluidos" :key="'concluido-'+index" class="col-md-4 mb-4">
            <div class="card custom-card">
              <div class="card-img-top" style="height: 180px; overflow: hidden; border-top-left-radius: 15px; border-top-right-radius: 15px;">
                <img
                  :src="curso.imagem"
              ...
              <div class="card-body">
                ...
                <a href="#" class="btn btn-custom mt-3">Ver Certificado</a>
              </div>
            </div>
          </div>
          
          <!-- Mensagem quando não há cursos concluídos -->
          <div v-if="usuario.cursosConcluidos.length === 0" class="col-12 text-center py-4">
